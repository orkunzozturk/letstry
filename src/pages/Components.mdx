...
[silkscreen pic with polarity indication]
...
For SMDs (Surface Mount Devices), a large area of ​​copper should be laid in the body part, preferably connected to the GND plane, functioning as a thermal pad for heat dissipation. For THT components, it is generally possible to parallel several devices on the same physical heat sink.
