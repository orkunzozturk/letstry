...
Through holes are commonly used as [THT component](/articles/Package-Types-Soldering/#through-hole-technology) inserts. NexPCB supports 2 ways of creating through holes:
...
**Designing Through Holes**
There are several things to consider when designing through holes: 
...
![Distance between holes](images/vias-holes-05.png)

- The distance between hole plates is: A ≥ 20mil. 

- The distance between hole plate and copper foil is: B ≥ 20mil, C ≥ 20mil. 

- The minimum distance between PTH and hole to outline is the distance that can ensure the distance from the bonding pad to the hole to outline is: D ≥ 20mil. 

- The recommended minimum distance between NPTH and hole to outline is E ≥ 40mil.

![Hole location from pad](images/vias-holes-06.png)

- The through holes cannot be designed on a bonding pad, and should be connected by a short printed line. 

- The minimum distance between a hole wall and a bonding pad is 0.2 mm. 

- There should be no through holes in the extending outward 1.5 mm area of the contacting part of devices metal shell and PCB.

![Incorrect positioning of holes in between pads](images/vias-holes-07.png)
- Through holes cannot be located between two bonding pads meant for one component's placement. 
...
![Through Hole Via](images/vias-holes-01.png)
...
![Blind Via](images/vias-holes-02.png)
...
![Buried Via](images/vias-holes-03.png)
...
Microvias, are small vias that are usually created with a laser and done before the lamination process. In [HDI PCBs](/articles/PCB-Types/#hdi-pcbs), microvias are typically used to allow denser placement of components. They typically have a 1:1 diameter to depth ratio, and hence are formed in a stacked or staggered configuration.

![Stacked vs Staggered Vias](/images/vias-holes-04.png)
...
One of the problems caused by these configurations is the generation of EMC radiation. This radiation is caused by the change in the characteristic impedance of the board, due to the short stubs created on the layer where the vias aren't routed. !  
...
Resin plugging is most commonly done to vias in [HDI circuit boards](/articles/PCB-Types/#hdi-pcbs), where many via-in-pads are used.
