...
In addition to the normative names, ISO International Standards also have numbers. The format of the numbering is:*"ISO"* + *standard number* + [*bar* + *sub-standard number*] + *":" + *release year* (contents in square brackets are optional, for example: ISO8402:1987, ISO9000-1:1994, etc., respectively a certain one standard number). 
...
"ISO9000" does not refer to a standard, but a general term for a family of standards, mainly including four core standards: ISO 9000, ISO 9001, ISO 9004 and ISO 9011, of which ISO 9001 is the standard requirement for third-party certification. 
...
**Purpose**: to establish ISO9001 quality management system; to improve customer satisfaction by providing customers with products that meet their requirements. 
...
1.	Strengthen quality management to provide corporate benefits, by enhancing customer's confidence and expanding market shares. 
