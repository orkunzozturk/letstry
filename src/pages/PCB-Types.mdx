...
![Standard PCB](/images/pcb-types-standard.png)
...
![Flex PCB](/images/pcb-types-flex.png)
...
![Flex PCB Layers](/images/pcb-types-flexlayer.png)
...
This layer is composed of two conducting layers and an insulating layer in between. The commonly used material for substrates is a combination of PI (Polyimide) for the insulating layer and copper for the conducting layers. The layers could be attached together with the help of an adhesive, or bonded together through electroplating, coating, or hot processing methods.
...
Such as glue, electromagnetic protective film, and copper foil.

## Rigid-Flex PCBs

![Rigid-Flex PCB](/images/pcb-types-rigidflex.png)


A drawback of having flexible boards is that it's not as robust and strong as standard PCBs. To add strength to these PCBs, the features of the two are merged, creating the _rigid-flex PCBs_.
...
| ----------- | ------------------- |
| Layer Count | 1-10                |
| Dimension   | Max: 200 \* 800 mm  |
| Thickness   | 0.08 ~ 1.0mm (±10%) |

The bending radius and bending cycles of flex and rigid-flex PCBs are as follows,

![Bending Radius](/images/pcb-types-bendingradius.png)

| Bending Radius  | Bending Cycles |
| --------------- | -------------- |
| 5 x thickness   | 1              |
| 24 x thickness  | 100            |
| 250 x thickness | > 10,000       |

## HDI PCBs

![HDI PCB](/images/pcb-types-hdi.png)
HDI, or High-Density Interconnector PCBs, are PCBs with higher wiring density per unit area. HDI implements the application of [microvias, blind and buried vias](/articles/Vias-Holes/#microvias), also smaller components (e.g. by implementing [BGA components](/articles/)).
...
With a smaller area, HDI PCBs generally have better signal integrity, since stray [inductance](/articles/Impedance/#inductance) and [capacitance](/articles/Impedance/#capacitance) is reduced. The sizes of HDI PCB's vias are generally smaller than any standard PCB's vias, ranging from around 0.075 mm to a maximum of 0.15 mm.
