...
A drawback of having flexible boards is that it's not as robust and strong as standard PCBs. To add strength to these PCBs, the features of the two are merged, creating the *rigid-flex PCBs*. 
